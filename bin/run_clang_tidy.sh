...
if type nproc >/dev/null 2>&1; then
    ...
    # This script has been tested when CORES is actually higher than the number of cores
    # on the system, and the system remained responsive, so it's OK to guess here.
    CORES=7
fi
