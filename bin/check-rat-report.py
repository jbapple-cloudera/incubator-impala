...
# Usage:
#
#   1. Either download a release candidate or create an archive from your git repo using
#      `git archive --prefix=Foo/ -o baz.tar.gz HEAD`
#   2. Untar and run `java -jar apache-rat-0.12.jar -x . >baz.xml`. Only RAT version 0.12
